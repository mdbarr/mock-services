...
function PaymentMethods (mock, stripe) {
  ...
  mock.api.post('/v1/payment_methods', stripe.req, stripe.auth.requireAdmin, this.createPaymentMethod);
  mock.api.get('/v1/payment_methods', stripe.req, stripe.auth.requireAdmin, this.listPaymentMethods);
  mock.api.get('/v1/payment_methods/:id', stripe.req, stripe.auth.requireAdmin, this.retrievePaymentMethod);
  mock.api.post('/v1/payment_methods/:id/attach', stripe.req, stripe.auth.requireAdmin, this.attachPaymentMethod);
  mock.api.post('/v1/payment_methods/:id/detach', stripe.req, stripe.auth.requireAdmin, this.detachPaymentMethod);
}
