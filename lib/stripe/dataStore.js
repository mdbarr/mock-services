...
function DataStore (mock, stripe) {
  ...
  this.addPaymentMethod = (identity, id, method) => this.addItem(store.payment_methods, identity, id, method);
  this.getPaymentMethod = (identity, id) => this.getItem(store.payment_methods, identity, id);
  this.updatePaymentMethod = (identity, id, method) => this.updateItem(store.payment_methods, identity, id, method);
  this.deletePaymentMethod = (identity, id) => this.deleteItem(store.payment_methods, identity, id);
  this.getPaymentMethods = (identity) => this.getAllItems(store.payment_methods, identity);
  ...
  this.addProduct = (identity, id, product) => this.addItem(store.products, identity, id, product);
  this.getProduct = (identity, id) => this.getItem(store.products, identity, id);
  this.updateProduct = (identity, id, product) => this.updateItem(store.products, identity, id, product);
  this.deleteProduct = (identity, id) => this.deleteItem(store.products, identity, id);
  this.getProducts = (identity) => this.getAllItems(store.products, identity);
